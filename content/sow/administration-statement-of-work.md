...
Superimmersive will develop a **3-week Proof of Concept (POC)** demonstrating web-based AI voice-driven customer-service calling.
...
AI voice for the simulated customer is included for the single scenario. Additional voices, languages and scenario libraries are not included.
...
Web call interface, start / end / reset.

## Week 2 - AI Conversation

One scenario path with AI voice-driven customer responses.

## Week 3 - Testing & Refinement

Pacing, prompts and demonstration polish in the browser.
...
The POC will be considered successfully delivered when the agreed core functionality can be demonstrated on the target **Web** platform.
